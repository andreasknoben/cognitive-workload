...
def compute_eeis(yesno, openq, cloze, total):
    for iChan in range(NCHAN):
        ...
        yesno = update_dataframes(yesno, chan_result_control_yesno_FE, chan_result_treatment_yesno_FE,
                                      chan_result_control_yesno_VB, chan_result_treatment_yesno_VB, iChan)
        openq = update_dataframes(openq, chan_result_control_open_FE, chan_result_treatment_open_FE,
                                     chan_result_control_open_VB, chan_result_treatment_open_VB, iChan)
        cloze = update_dataframes(cloze, chan_result_control_cloze_FE, chan_result_treatment_cloze_FE,
                                      chan_result_control_cloze_VB, chan_result_treatment_cloze_VB, iChan)
